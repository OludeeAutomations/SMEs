    ...
    <body>
      <main class="page">
        ...
        <section class="bottom">
          <div class="notes"><div class="label">Terms & notes</div><div class="note-copy">${escapeHtml(invoice.terms || String(preferences?.invoiceFooter ?? 'Thank you for your business. Please make payment by the due date and reference the invoice number.'))}</div></div>
        ...
        <footer class="footer">Generated by Rekọda · ${escapeHtml(business.name)}</footer>
      </main>
    </body>
  </html>`;
}
