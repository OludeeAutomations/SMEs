...
export default function EaseCustomersScreen() {
  ...
  return <SafeAreaView className="flex-1 bg-[#F5F7FB]" edges={['top']}><ScrollView contentContainerClassName="gap-4 px-5 pb-8 pt-5">
    ...
    <View className="h-14 flex-row items-center gap-2 rounded-[5px] border border-[#DCE3EE] bg-white px-4"><Search size={18} color={colors.muted}/><TextInput value={search} onChangeText={setSearch} placeholder="Search customers" placeholderTextColor={colors.muted} className="flex-1 text-sm text-[#0F172A]" /></View>
