...
export default function SupplierDetail() {
  ...
  return <SafeAreaView className="flex-1 bg-[#F5F7FB]" edges={['top']}>
    <ScrollView contentContainerClassName="gap-4 px-5 pb-28 pt-5">
      ...
      <Button title="View supplier bills" variant="secondary" onPress={() => router.push('/(app)/suppliers/bills')} />
      <Button title="Delete supplier" variant="secondary" onPress={remove} />
    </ScrollView>
  </SafeAreaView>;
}
