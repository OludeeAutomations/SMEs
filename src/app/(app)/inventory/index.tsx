...
<View className="rounded-[5px] border border-[#FED7AA] bg-[#FFF7ED] p-4"><Text className="text-[10px] font-bold text-[#B45309]">LOW STOCK ALERT</Text><Text className="mt-2 text-xs leading-[18px] text-[#92400E]">Cooking oil, sugar, and detergent may run out within 4 days based on current sales pace.</Text></View>
